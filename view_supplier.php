<div class="container-fluid py-1">
	<?php include 'print_supplier.php' ?>
</div>
...
<script>
	$('#print').click(function(){
		start_load()
		var nw = window.open('print_supplier.php?supplier_id=<?php echo $_GET['supplier_id'] ?>&supplier_id=<?php echo $_GET['supplier_id'] ?>',"_blank","width=900,height=600")
		setTimeout(function(){
			nw.print()
			setTimeout(function(){
				nw.close()
