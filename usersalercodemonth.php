...
// date_format(sp.created_date,'%Y-%m-%d') = {$_GET['month']} and   BETWEEN '".$_POST["start_date"]."' AND '".$_POST["end_date"]."' GROUP BY username"
?>
      ...
      <div class="col-md-12">
        <div class="card">          
          ...
          <b>User customer view</b>            
           <span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="saleusermonth.php" id="new_supplier">
