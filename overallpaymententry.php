...
<div class="container-fluid">
	<form id="manage-payment">
		...
		<input type="hidden" id="id" value="<?php echo isset($id) ? $id : '' ?>">
		 ...
		 <div class="form-group">
            ...
            <select name="supppliername" id="supppliername" class="custom-select input-sm select2" cols="30" rows="4" required="">
               ...
               <option selected="" value="<?php echo isset ($supppliername)? $supppliername :'' ?>"><?php echo isset ($companyname)? $companyname :'' ?></option> 
                 <?php
 		...
 		<div class="form-group">
            ...
            <input type="number" class="form-control text-right" name="currentpayment" id="currentpayment"  value="" >
        </div>
        ...
        <div class="col-lg-6">
            ...
            <input type="number" class="form-control text-right" id="balance"  value="<?php echo isset ($amountpaid)? $amountpaid :'' ?>" readonly>
            <input type="number" class="form-control text-right" id="amountpaid" name="amountpaid" value="" readonly>
        </div>

 		 <div class="form-group">
            <label for="" class="control-label">Amount Payable</label>
            <input type="number" class="form-control text-right" name="" id="amountt"  value="<?php echo isset ($amountpayable)? $amountpayable :'' ?>" readonly>
         ...
         <div class="form-group">        	
            ...
            <textarea name="remark" id="" cols="10" rows="3" class="form-control" ><?php echo isset ($remark)? $remark :'' ?></textarea>
...
<script>
 ...
 $("#amountpayable").val(multtotal3);
	...
	//$('#manage-payment').submit(function(e){
		...
		e.preventDefault()
		start_load()
		var x = $("#currentpayment").val();
		var y = $("#suppliercurrentbilling").val();
		 if( x == '' && y == ''){
