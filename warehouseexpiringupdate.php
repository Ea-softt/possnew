         ...
         <div class="row "> 
            ...
            <select name="companynameid" id="companynameid" class="custom-select input-sm select2"  cols="30" rows="4" required=""> <!-- onchange="FetchState(this.value) -->
                ...
                <?php endwhile; ?>              
                                ...
                                <td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-pen-alt"></i></span></div><input type="text" name="name" class="form-control-sm form-control" value="<?php echo isset($name) ? $name : '' ?>" placeholder="Enter Product Name" required></div></td>
                            </tr>
...
$(document).on('click', '#cancel', function(){
   ...
   .then((reload) => {
      if (reload) {
        location.reload();
        window.location.href='warehouseexpiringdate.php?'
      }
    });
