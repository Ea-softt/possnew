<div class="container-fluid py-1">
	<?php include 'print_customer.php' ?>
</div>
...
<script>
	$('#print').click(function(){
		start_load()
		var nw = window.open('print_customer.php?customer_id=<?php echo $_GET['customer_id'] ?>&customer_id=<?php echo $_GET['customer_id'] ?>',"_blank","width=900,height=600")
		setTimeout(function(){
			nw.print()
			setTimeout(function(){
				nw.close()
