<div class="container-fluid py-1">
	<?php include 'print_salerecode.php' ?>
</div>
...
<script>
	$('#print').click(function(){
		start_load()
		var nw = window.open('print_salerecode.php?reciept_no=<?php echo $_GET['reciept_no'] ?>&reciept_no=<?php echo $_GET['reciept_no'] ?>',"_blank","width=900,height=600")
		setTimeout(function(){
			nw.print()
			setTimeout(function(){
				nw.close()
