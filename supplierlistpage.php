...
<body>
 ...
 <div class="main-content" id="mainContent">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-2 border-bottom">
        <h1 class="h2" style="margin-left: 15%">List of Supplier</h1>
            ...
            <table id="mytable" class="table table-condensed table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <button class="btn btn-sm btn-outline-primary view_exam" type="button" data-id="<?php echo $row['supplier_id'] ?>"
                      data-examin_ID="<?php echo $row['supplier_id'] ?>">View</button>


                    <button class="btn btn-sm btn-outline-primary edit_exam" type="button" data-id="<?php echo $row['supplier_id'] ?>" >Edit</button>
                    <button class="btn btn-sm btn-outline-danger delete_supplier" type="button" data-id="<?php echo $row['supplier_id'] ?>">Delete</button>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
...
$('.view_exam').click(function(){
    uni_modal("Report Details","view_supplier.php?supplier_id="+$(this).attr('data-examin_ID')+"&supplier_id="+$(this).attr('data-id'),"mid-large")
    
  })

  
  $('#new_supplier').click(function(){
    uni_modal("Suppliers Entry","Suppliers.php",'small')
    
  })

  $('.edit_exam').click(function(){
    uni_modal("Edit Suppliers ","Suppliers.php?supplier_id="+$(this).attr('data-id'),'small')
    
  })
  $('.delete_supplier').click(function(){
    _conf("Are you sure to delete this Suppliers?","delete_supplier",[$(this).attr('data-id')])
  })
  ...
  function delete_supplier($id){
    start_load()
    $.ajax({
      url:'easoftfun.php?action=delete_supplier',
      method:'POST',
      data:{id:$id},
