    ...
    <!-- Main Content -->
     <div class="main-content" id="mainContent">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-2 border-bottom">
        <h1 class="h2" style="margin-left: 15%">Product Expiring information</h1>
            ...
            <table id="mytable" class="table table-condensed table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Expiring Status</th>
                  ...
                  <td class="text-center">
                    ...
                    <p> <b>
                      ...
                      if($td>$exp){
                        ...
                        echo "<p class ='text-danger'>Product Expired<p>";
                        echo "<br/>".$x;
                        ...
                        echo "<p class ='text-success'>Product not Expired";
                        echo "<br/>".$x;
...
$('#view_exam').click(function(){
  ...
  $('.edit_exam').click(function(){
    uni_modal("Edit Product ","warehouseexpiringupdate.php?sid="+$(this).attr('data-id'),'small')
