...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-2 border-bottom">
  <h1 class="h2" style="margin-left: 15%">BARCODE GENERATOR</h1>        
</div>
  ...
  <div style="margin: 1%;">
    <form class="form-horizontal" method="post" action="barcode.php" target="_blank">
       ...
       <label for="" class="control-label">Product</label>        
            ...
            <select  class="custom-select input-sm select2" onchange="FetchState(this.value)" cols="30" rows="4">
      ...
      <div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-search"></i></span></div>
          <input class="form-control" type="text" placeholder="Product Search" aria-label="Search" id="search" required=""  onkeyup="loadpro();"/>
        </div></div>
  <br/>
  <hr>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button width="30" class="btn btn-primary btn-sm" type="submit" id="add_moneyout">Submit</button>
