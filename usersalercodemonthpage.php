...
$fees = $conn->query("SELECT sp.*,us.*,ct.* FROM sales sp inner join newemployee us on sp.username = us.EmpID inner join customer ct on sp.customer_id = ct.customer_id where strftime('%Y%m%d', sp.created_date) BETWEEN '{$_GET["start_date"]}' AND '{$_GET["end_date"]}' AND sp.username = '{$_GET['username']}' order by strftime('%s', sp.created_date) asc ");
foreach($fees->fetch(PDO::FETCH_ASSOC) as $k => $v){
	$$k= $v;
}
?>
      ...
      <div class="col-md-12">
        <div class="card">          
            ...
            <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn btn-primary btn-sm" href="e_cash_infpage.php" id="new_supplier">
