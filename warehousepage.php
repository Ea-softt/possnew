    ...
    <!-- Main Content -->
     <div class="main-content" id="mainContent">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-2 border-bottom">
        <h1 class="h2" style="margin-left: 15%">Warehouse Item</h1>
        ...
        <div class="card">
              <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn btn-primary btn-sm" href="javascript:void(0)" id="new_supplier">
                     ...
                     <a class="btn btn-danger btn-sm" href="javascript:void(0)" id="view_exam">
                        <i class="fa fa-print"></i> Print
                    </a>

           <!--  <span class="float:right"><a class="btn btn-danger btn-block btn-sm col-sm-2 float-right"  id="view_exam">
          <i class="fa fa-print"></i> print
        </a></span> -->
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <p> <b><?php echo $row['expire_date'] ?></b></p>
                      ...
                      <td class="text-center">
                    <img src="<?php echo base64_decode($row['picture']) ? '../img/'.$row['picture'] :'' ?>" alt="mdo" width="32" height="32" >
                    </td>

                  <td class="text-center">
                    
                    <button class="btn btn-sm btn-outline-primary edit_exam" type="button" data-id="<?php echo $row['sid'] ?>" >Edit</button>
                    <button class="btn btn-sm btn-outline-danger delete_warehouse" type="button" data-id="<?php echo $row['sid'] ?>">Delete</button>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
...
$('#view_exam').click(function(){
    uni_modal("Report Details","view_warehouse.php?","large")
  ...
  $('.edit_exam').click(function(){
    uni_modal("Edit Product ","warehousecontrol.php?sid="+$(this).attr('data-id'),'small')
    
  })
  $('.delete_warehouse').click(function(){
    _conf("Are you sure to delete this Product?","delete_warehouse",[$(this).attr('data-id')])
  })
  
  
  function delete_warehouse($sid){
    start_load()
    $.ajax({
      url:'easoftfun.php?action=delete_warehouse',
      method:'POST',
      data:{sid:$sid},
