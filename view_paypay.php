...
</style><!-- var nw = window.open('receipt.php?ef_id=<?php echo $_GET['ef_id'] ?>&pid=<?php echo $_GET['pid'] ?>',"_blank","width=900,height=600") -->
<script>
	$('#print').click(function(){
		start_load()
		var nw = window.open('receipt.php?paymen_supplierID=<?php echo $_GET['paymen_supplierID'] ?>&pid=<?php echo $_GET['pid'] ?>',"_blank","width=900,height=600")
		setTimeout(function(){
			nw.print()
			setTimeout(function(){
				nw.close()
