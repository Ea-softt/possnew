        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown  text-success" style="width: 90px;">
            ...
            <ul class="dropdown-menu bg-dark text-white" aria-labelledby="dropdown05">
              <li><a class="dropdown-item text-success" href="newEmployee.php"> Employees</a></li>
           ...
           <li class="nav-item dropdown text-success" style="width: 120px;">
            <a class="nav-link"  aria-current="page" href="customerlist.php" id="dropdown05" ><i class="fas fa-users"></i> Customer</a>
...
<!-- 
          ...
          <li class="nav-item dropdown text-success" style="width: 90px;">
            ...
            <ul class="dropdown-menu bg-dark" aria-labelledby="dropdown05">
             <li><a class="dropdown-item text-success" href="salerecode.php">Sale C</a></li>
              <li><a class="dropdown-item text-success" href="salestatistics.php">Sale statistics</a></li>
        ...
        <a href="#" class="d-block link-secondary text-decoration-none text-success dropdown-toggle" id="dropdownUser2" data-toggle="dropdown" aria-expanded="false" style="margin-left: 70px; "><?php echo $FullName;?>
