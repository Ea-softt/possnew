...
<body>
    ...
    <div class="sidebar p-3" id="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link active" href="mainpa.php">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu bg-dark">
                    ...
                    <li><a class="dropdown-item text-success" href="saleusertwopagepage.php">Daily Sale</a></li>
   ...
   <div class="main-content" id="mainContent">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-2 border-bottom">
        <h1 class="h2" style="margin-left: 15%">List of Customer </h1>
      ...
      <div class="col-md-12">
        <div class="card">
         <!--  <div class="card-header bg-success text-white">
            <b>Customer list </b>
            <span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_supplier">
          <i class="fa fa-plus"></i> New 
           ...
           <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                    <b>Customer list</b>
                    <a class="btn btn-primary btn-sm" href="javascript:void(0)" id="new_supplier">
          ...
          <div class="card-body">
            <table id="mytable" class="table table-condensed table-bordered table-hover">
              ...
              <tbody>
                <?php 
                $i = 1;
                $fees = $conn->query("SELECT * FROM customer order by customer_id desc ");
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <p> <b><?php echo $row['firstnamec'].' '.$row['lastnamec'] ?></b></p>
                   ...
                   <!--  <input type="file" class="form-control" name="img" onchange="displayImg(this,$(this))" class="rounded-circle">-->
                     <td class="text-center">  

                    <img src="<?php echo base64_decode($row['image']) ? '../img/'.$row['image'] :'' ?>" alt="mdo" width="32" height="32" >
                    </td>

                  <td class="text-center">
                    <button class="btn btn-sm btn-outline-primary view_exam" type="button" data-id="<?php echo $row['customer_id'] ?>"
                      data-examin_ID="<?php echo $row['customer_id'] ?>">View</button>

                      <button class="btn btn-sm btn-outline-primary edit_exam" type="button" data-id="<?php echo $row['customer_id'] ?>" >Edit</button>
                    <button class="btn btn-sm btn-outline-danger delete_customer" type="button" data-id="<?php echo $row['customer_id'] ?>">Delete</button>
                  </td>
                </tr>
                <?php endwhile; ?>
              </tbody>
...
$('.view_exam').click(function(){
    uni_modal("Report Details","view_customer.php?customer_id="+$(this).attr('data-examin_ID')+"&customer_id="+$(this).attr('data-id'),"mid-large")
  ...
  $('.edit_exam').click(function(){
    uni_modal("Edit Customer ","customer.php?customer_id="+$(this).attr('data-id'),'small')
  ...
  function delete_customer($id){
    start_load()
    $.ajax({
      url:'easoftfun.php?action=delete_customer',
      method:'POST',
      data:{id:$id},
