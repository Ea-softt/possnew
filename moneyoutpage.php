          ...
          <div class="card-body">
            ...
            <table id="mytable" class="table table-condensed table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                   ...
                   <td class="text-center text-danger">
                     <p><small><i><b><?php echo $row['total_amount'] ?></i></small></p>
                  </td>
                 
                  <td class="text-center">                    
                  <button class="btn btn-sm btn-outline-primary edit_moneyout" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
                    <button class="btn btn-sm btn-outline-danger delete_moneyout" type="button" data-id="<?php echo $row['id'] ?>" >Delete</button>
                  </td>
                </tr>
               <?php 
                        endforeach;
               ...
               <tfoot>
                        <tr>
                            <th colspan="5" class="text-right text-danger ">Total</th>
                            <th class="text-right text-danger"><?php echo number_format($total,2) ?></th>
                            <th></th>
                        </tr>
                    </tfoot>
            </table>
...
<style>
 ...
 $(document).ready(function(){
  ...
  $('#new_moneyout').click(function(){
    uni_modal("Money Out Entry","moneyout_control.php",'large')
    
  })

  $('.edit_moneyout').click(function(){
    uni_modal("Edit Money Out ","moneyout_control.php?id="+$(this).attr('data-id'),'large')
    
  })
 $('.delete_moneyout').click(function(){
    _conf("Are you sure to delete this Money Out?","delete_moneyout",[$(this).attr('data-id')])
  })
  
  function delete_moneyout($id){
    start_load()
    $.ajax({
      url:'easoftfun.php?action=delete_moneyout',
      method:'POST',
      data:{id:$id},
