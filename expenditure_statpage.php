      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header bg-success text-white">
            <b>Statistic of your profit or loss </b>
            <span class="float:right"><!-- <a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_moneyin">
          ...
          <div class="card-body">
            ...
            <table id="mytable" class="table table-condensed table-bordered table-hover">
              ...
              <tbody>
                ...
                $student_rows = $student->fetchAll(PDO::FETCH_ASSOC);
                ...
                <tr>
                  ...
                  <td class="text-center">
                     <p><small><i><b><?php echo $row['Month'] ?></i></small></p>
                  </td>
                  <td class="text-center">
                     <p><small><i><b><?php echo $row['Year'] ?></i></small></p>
                  </td>
                  <td class="text-center">
                     <p><small><i><b><?php echo $row['Name'] ?></i></small></p>
                  </td>


                  <td class="text-center">
                     <p><small><i><b><?php echo number_format($row['profit'],2) ?></i></small></p>
                  </td>
                 <td class="text-center">
                     <p><small><i><b><?php echo number_format($row['loss'],2) ?></i></small></p>
                  </td>
                  <td class="text-center">                  

                  <p><small><i><b><?php echo number_format($row['Remark'],2) ?></i></small></p>
                  </td>
                  <td class="text-center">              
                  <p><small><i><b><?php 
                 
                $t =  number_format($row['Remark']); 
                 if ($t <= -1 ){
                  echo "<div class='text-danger'>Loss</div>";
                        }
                 else if ($t >= 1){
                 echo "<div class='text-success'>Profit</div>";
                           }
                else if ($t == 0){
                 echo "<div class='text-warning'>No P and No L</div>";
                           }
               ...
               <tfoot>
                 ...
                 if ($t <= -1){
                  echo "<div class='text-danger text-right'>$t</div>";
                        }
                 else if ($t >= 1){
                 echo "<div class='text-success text-right'>$t</div>";
                           }
                else if ($t == 0){
                 echo "<div class='text-warning text-right'>$t</div>";
                           }
                ...
                $t =  number_format($total,2); 
                 if ($t <= -1){
                  echo "<div class='text-danger text-right'>Loss</div>";
                        }
                 else if ($t >= 1){
                 echo "<div class='text-success text-right'>Profit</div>";
                           }
                else if ($t == 0){
                 echo "<div class='text-warning text-right'>No P and No L</div>";
                           }
...
<style>
  ...
  $('#new_moneyin').click(function(){
    uni_modal("Money in Entry","moneyin_control.php",'large')
    
  })

  $('.edit_moneyin').click(function(){
    uni_modal("Edit Money In ","moneyin_control.php?id="+$(this).attr('data-id'),'large')
    
  })
 $('.delete_moneyin').click(function(){
    _conf("Are you sure to delete this Money In?","delete_moneyin",[$(this).attr('data-id')])
  })
  
  function delete_moneyin($id){
    start_load()
    $.ajax({
      url:'easoftfun.php?action=delete_moneyin',
      method:'POST',
      data:{id:$id},
